<template>
  ...
  >
    <!-- OG-Image (Grid-Ansicht) -->
    <div v-if="!compact && bookmark.ogImage" class="relative bg-gray-100 dark:bg-gray-800 h-40 overflow-hidden">
      <img
    ...
    <!-- Favicon (Kompakt-Ansicht) -->
    <div v-if="compact" class="flex justify-center items-center bg-gray-100 dark:bg-gray-800 rounded-xl w-10 h-10 overflow-hidden shrink-0">
      <img
      ...
      <div class="flex justify-between items-start gap-2">
        <div class="flex-1 min-w-0">
          ...
          <div class="flex flex-wrap items-center gap-2 mt-1.5">
            ...
            <span v-if="bookmark.isDeadLink" class="inline-flex items-center gap-1 text-red-500 text-xs" title="Toter Link">
        ...
        <div class="flex items-center gap-0.5 shrink-0">
          ...
          <button
            ...
            class="p-1.5 rounded-lg transition"
            :title="bookmark.isRead ? 'Als ungelesen markieren' : 'Als gelesen markieren'"
          >
...
const emit = defineEmits(["edit", "delete", "toggleFavorite", "toggleRead"]);
