export default {
  ...
  "settings.telegramDescription": "Erstelle deinen eigenen Telegram-Bot und speichere Links direkt per Chat. Jeder Benutzer verwendet seinen eigenen Bot – privat und sicher.",
  ...
  "settings.telegramSetup": "Schritt-für-Schritt-Anleitung",
  "settings.telegramSetupIntro": "Die Einrichtung dauert nur 2 Minuten und ist komplett kostenlos.",
  "settings.telegramStep1Title": "BotFather öffnen",
  "settings.telegramStep1": "Öffne Telegram und suche nach @BotFather oder klicke auf den Link:",
  "settings.telegramStep1Link": "https://t.me/BotFather",
  "settings.telegramStep2Title": "Bot erstellen",
  "settings.telegramStep2": "Sende /newbot an den BotFather und folge den Anweisungen:",
  "settings.telegramStep2a": 'Wähle einen Namen für deinen Bot (z.B. "Meine Lesezeichen")',
  "settings.telegramStep2b": 'Wähle einen Benutzernamen, der auf _bot enden muss (z.B. "meine_lesezeichen_bot")',
  "settings.telegramStep3Title": "Token kopieren",
  "settings.telegramStep3": "Der BotFather sendet dir ein Token – eine lange Zeichenkette wie:",
  "settings.telegramStep3Example": "123456789:ABCdefGHIjklMNOpqrSTUvwxYZ",
  "settings.telegramStep3Hint": "Kopiere dieses Token und füge es unten ein.",
  "settings.telegramStep4Title": "Token einfügen",
  "settings.telegramStep4": 'Füge das Token hier ein und klicke auf "Verbinden".',
  "settings.telegramStep5Title": "Fertig!",
  "settings.telegramStep5": "Öffne deinen Bot in Telegram, sende /start und schicke ihm dann einfach Links!",
  "settings.telegramTokenLabel": "Bot-Token",
  "settings.telegramTokenPlaceholder": "123456789:ABCdefGHI...",
  "settings.telegramConnect": "Verbinden",
  "settings.telegramConnecting": "Verbinde...",
  "settings.telegramDisconnect": "Bot trennen",
  "settings.telegramDisconnectConfirm": "Telegram-Bot wirklich trennen? Dein Bot wird gestoppt.",
  "settings.telegramCommands": "Bot-Befehle",
  "settings.telegramCmdStart": "/start – Bot aktivieren",
  ...
  "settings.telegramLinked": "Bot aktiv",
  "settings.telegramNotLinked": "Nicht verbunden",
  "settings.telegramBotName": "Dein Bot: @{username}",
  "settings.telegramOpenBot": "Bot in Telegram öffnen",
  ...
  "folders.aiLabel": "AI Einsortieren",
  "folders.aiSortOnlyLabel": "Nur einsortieren",
  "folders.aiWorking": "AI sortiert ein\u2026",
  "folders.aiSuccess": "In \"{folder}\" einsortiert",
  "folders.aiError": "AI-Einsortierung fehlgeschlagen",
  "folders.aiShiftHint": "nur bestehende Ordner",
  // New Folder
