  ...
  <div class="flex bg-gray-50 dark:bg-gray-950 min-h-screen">
    ...
    >
      ...
      <div class="flex items-center gap-3 px-6 border-gray-200 dark:border-gray-800 border-b h-16 shrink-0">
        ...
        <span class="font-bold text-gray-900 dark:text-white text-lg">Keepomat</span>
      </div>
      ...
      <nav class="flex-1 space-y-1 px-3 py-4 overflow-y-auto">
        ...
        <div class="pt-4">
          <div class="flex justify-between items-center mb-2 px-3">
            <span class="font-semibold text-gray-400 dark:text-gray-500 text-xs uppercase tracking-wider">Ordner</span>
            <button
          ...
          />
          <p v-else class="px-3 text-gray-400 dark:text-gray-500 text-sm">Keine Ordner</p>
        </div>
      </nav>
      ...
      <header class="flex items-center gap-4 bg-white dark:bg-gray-900 px-4 lg:px-6 border-gray-200 dark:border-gray-800 border-b h-16 shrink-0">
        ...
        <div class="flex items-center gap-2">
          ...
          >
            ...
            <span class="hidden sm:inline">Lesezeichen</span>
          </button>
        </div>
      </header>
